...
type ClientpackListResponse struct {
	Response *map[string]Clientpack `json:"response,omitempty"`
}
...
func (o *ClientpackListResponse) GetResponse() map[string]Clientpack {
	if o == nil || o.Response == nil {
		var ret map[string]Clientpack
		return ret
	}
	return *o.Response
}
...
func (o *ClientpackListResponse) GetResponseOk() (*map[string]Clientpack, bool) {
	if o == nil || o.Response == nil {
		return nil, false
	}
...
// SetResponse gets a reference to the given map[string]Clientpack and assigns it to the Response field.
func (o *ClientpackListResponse) SetResponse(v map[string]Clientpack) {
	o.Response = &v
}
