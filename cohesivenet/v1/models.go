...
type CreatePluginInstance struct {
	...
	ManagerConfig struct {
		...
		ConfigurationFiles []struct {
			...
			} `json:"previous_versions,omitempty"`
		} `json:"configuration_files,omitempty"`
		Ports []struct {
		...
		} `json:"process_manager,omitempty"`
		Executables []struct {
			Path     string `json:"path,omitempty"`
			Name     string `json:"name,omitempty"`
			Commands struct {
...
type CreatePluginInstanceResponse struct {
	Instance struct {
		...
		Name          string `json:"name,omitempty"`
		Description   string `json:"description,omitempty"`
		PluginImageID int    `json:"plugin_image_id,omitempty"`
		ContainerID   int    `json:"container_id,omitempty"`
		Tags          struct {
		} `json:"tags,omitempty"`
		ExportedFiles    []interface{} `json:"exported_files,omitempty"`
		CreatedAt        time.Time     `json:"created_at,omitempty"`
		UpdatedAt        time.Time     `json:"updated_at,omitempty"`
		ContainerImageID int           `json:"container_image_id,omitempty"`
		PluginID         int           `json:"plugin_id,omitempty"`
		ImageName        string        `json:"image_name,omitempty"`
		Command          string        `json:"command,omitempty"`
