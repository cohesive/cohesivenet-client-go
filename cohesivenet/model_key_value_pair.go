...
func (o *KeyValuePair) GetValue() AnyValue {
...
// and a boolean to check if the value has been set.
func (o *KeyValuePair) GetValueOk() (*AnyValue, bool) {
	if o == nil || o.Value == nil {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given AnyValue and assigns it to the Value field.
func (o *KeyValuePair) SetValue(v AnyValue) {
	o.Value = &v
}
