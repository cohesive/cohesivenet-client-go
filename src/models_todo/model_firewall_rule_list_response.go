...
type FirewallRuleListResponse struct {
	Response [][]FirewallRuleTupleInner `json:"response,omitempty"`
}
...
func (o *FirewallRuleListResponse) GetResponse() [][]FirewallRuleTupleInner {
	if o == nil || o.Response == nil {
		var ret [][]FirewallRuleTupleInner
		return ret
	}
	return o.Response
}
...
// SetResponse gets a reference to the given [][]FirewallRuleTupleInner and assigns it to the Response field.
