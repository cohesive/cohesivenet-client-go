...
func (r ApiDeleteSnapshotRequest) Execute() (*Object, *http.Response, error) {
...
//  @return Object
func (a *SnapshotsApiService) DeleteSnapshotExecute(r ApiDeleteSnapshotRequest) (*Object, *http.Response, error) {
	var (
...
func (r ApiPostCreateSnapshotRequest) Execute() (*SnapshotsDetailResponse, *http.Response, error) {
...
func (a *SnapshotsApiService) PostCreateSnapshotExecute(r ApiPostCreateSnapshotRequest) (*SnapshotsDetailResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SnapshotsDetailResponse
	)
