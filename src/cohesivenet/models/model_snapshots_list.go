...
type SnapshotsList struct {
	...
	Snapshots *map[string]SnapshotsListSnapshotsValue `json:"snapshots,omitempty"`
}
...
// SetSnapshots gets a reference to the given map[string]SnapshotsListSnapshotsValue and assigns it to the Snapshots field.
