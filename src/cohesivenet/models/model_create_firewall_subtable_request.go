...
func (o *CreateFirewallSubtableRequest) GetRules() []CreateFirewallSubtableRequestRule {
...
// and a boolean to check if the value has been set.
func (o *CreateFirewallSubtableRequest) GetRulesOk() ([]CreateFirewallSubtableRequestRule, bool) {
	if o == nil || o.Rules == nil {
		return nil, false
	}
	return o.Rules, true
...
func (o *CreateFirewallSubtableRequest) SetRules(v []CreateFirewallSubtableRequestRule) {
	o.Rules = v
}
