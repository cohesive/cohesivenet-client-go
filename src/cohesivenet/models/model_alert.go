...
type Alert struct {
	...
	CustomProperties []AlertCustomPropertiesInner `json:"custom_properties,omitempty"`
}
...
func (o *Alert) GetCustomProperties() []AlertCustomPropertiesInner {
	if o == nil || o.CustomProperties == nil {
		var ret []AlertCustomPropertiesInner
		return ret
	}
...
// SetCustomProperties gets a reference to the given []AlertCustomPropertiesInner and assigns it to the CustomProperties field.
