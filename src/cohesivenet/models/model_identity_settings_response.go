...
type IdentitySettingsResponse struct {
	Response *IdentitySettingsResponseResponse `json:"response,omitempty"`
}
...
func (o *IdentitySettingsResponse) GetResponse() IdentitySettingsResponseResponse {
	if o == nil || o.Response == nil {
		var ret IdentitySettingsResponseResponse
		return ret
	}
	return *o.Response
}
...
// SetResponse gets a reference to the given IdentitySettingsResponseResponse and assigns it to the Response field.
