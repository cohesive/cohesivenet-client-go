...
type PeersDetail struct {
	...
	Managers *map[string]PeersDetailManagersValue `json:"managers,omitempty"`
	Controllers *map[string]PeersDetailManagersValue `json:"controllers,omitempty"`
}
...
func (o *PeersDetail) GetManagers() map[string]PeersDetailManagersValue {
	if o == nil || o.Managers == nil {
		var ret map[string]PeersDetailManagersValue
		return ret
	}
	return *o.Managers
}
...
// SetManagers gets a reference to the given map[string]PeersDetailManagersValue and assigns it to the Managers field.
...
// SetControllers gets a reference to the given map[string]PeersDetailManagersValue and assigns it to the Controllers field.
