...
type VNS3Controller struct {
	...
	OverlayIpaddress *TopologyClient `json:"overlay_ipaddress,omitempty"`
}
...
func (o *VNS3Controller) GetOverlayIpaddress() TopologyClient {
...
// and a boolean to check if the value has been set.
func (o *VNS3Controller) GetOverlayIpaddressOk() (*TopologyClient, bool) {
	if o == nil || o.OverlayIpaddress == nil {
		return nil, false
	}
...
// SetOverlayIpaddress gets a reference to the given TopologyClient and assigns it to the OverlayIpaddress field.
func (o *VNS3Controller) SetOverlayIpaddress(v TopologyClient) {
