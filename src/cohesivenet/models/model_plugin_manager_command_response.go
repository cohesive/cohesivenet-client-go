...
type PluginManagerCommandResponse struct {
	Response *PluginManagerCommandResponseResponse `json:"response,omitempty"`
}
...
func (o *PluginManagerCommandResponse) GetResponse() PluginManagerCommandResponseResponse {
	if o == nil || o.Response == nil {
		var ret PluginManagerCommandResponseResponse
		return ret
	}
	return *o.Response
}
...
// SetResponse gets a reference to the given PluginManagerCommandResponseResponse and assigns it to the Response field.
