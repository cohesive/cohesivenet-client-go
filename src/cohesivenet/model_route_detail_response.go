...
type RouteDetailResponse struct {
	Response *Route `json:"response,omitempty"`
}
...
func (o *RouteDetailResponse) GetResponse() Route {
...
func (o *RouteDetailResponse) GetResponseOk() (*Route, bool) {
	if o == nil || o.Response == nil {
		return nil, false
	}
...
// SetResponse gets a reference to the given Route and assigns it to the Response field.
func (o *RouteDetailResponse) SetResponse(v Route) {
	o.Response = &v
}
