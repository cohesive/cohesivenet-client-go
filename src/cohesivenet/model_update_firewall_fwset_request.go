...
func (o *UpdateFirewallFwsetRequest) GetEntries() []CreateFirewallEntryRequest {
...
// and a boolean to check if the value has been set.
func (o *UpdateFirewallFwsetRequest) GetEntriesOk() ([]CreateFirewallEntryRequest, bool) {
	if o == nil || o.Entries == nil {
		return nil, false
	}
...
func (o *UpdateFirewallFwsetRequest) SetEntries(v []CreateFirewallEntryRequest) {
	o.Entries = v
}
