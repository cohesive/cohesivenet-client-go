...
// PostTestLdapSettingsRequest struct for PostTestLdapSettingsRequest
type PostTestLdapSettingsRequest struct {
...
func NewPostTestLdapSettingsRequest(provider string) *PostTestLdapSettingsRequest {
	this := PostTestLdapSettingsRequest{}
...
func (o PostTestLdapSettingsRequest) MarshalJSON() ([]byte, error) {
...
type NullablePostTestLdapSettingsRequest struct {
	value *PostTestLdapSettingsRequest
	isSet bool
}

func (v NullablePostTestLdapSettingsRequest) Get() *PostTestLdapSettingsRequest {
	return v.value
}

func (v *NullablePostTestLdapSettingsRequest) Set(val *PostTestLdapSettingsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostTestLdapSettingsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostTestLdapSettingsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostTestLdapSettingsRequest(val *PostTestLdapSettingsRequest) *NullablePostTestLdapSettingsRequest {
	return &NullablePostTestLdapSettingsRequest{value: val, isSet: true}
}

func (v NullablePostTestLdapSettingsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostTestLdapSettingsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
